...
function vjfi__Phase10F__Phase10Target_wrapper takes nothing returns nothing
...
function vjassc__init_function_interfaces takes nothing returns nothing
    ...
    call TriggerAddAction(vjfi__Phase10F_trigger[1], function vjfi__Phase10F__Phase10Target_wrapper)
endfunction
