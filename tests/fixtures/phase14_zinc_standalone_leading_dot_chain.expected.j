...
globals
    constant boolean LIBRARY_Phase14StandaloneLeadingDotChain=true
...
function Phase14StandaloneLeadingDotChain___Test takes nothing returns nothing
    call s__Button_show(s__Button_setText(s__Button_create(1), "ok"), true)
endfunction
