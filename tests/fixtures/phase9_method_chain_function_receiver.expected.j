...
globals
    constant boolean LIBRARY_Phase9Receiver=true
...
function MakeNode takes integer value returns integer
    return s__Node_make(value)
endfunction

function Test takes nothing returns integer
    return s__Node_get(MakeNode(7))
endfunction
